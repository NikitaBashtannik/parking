...
public class PlaceController {
    ...
    @GetMapping("/{id}")
    public PlaceDto read(@PathVariable("id") Long id) throws ParkingException {
    ...
    @PutMapping("/{id}")
    public PlaceDto update(@Valid @RequestBody PlaceDto placeDto, @PathVariable("id") Long id) throws ParkingException {
